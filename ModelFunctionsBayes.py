...
class modelFuncs():
    ...
    def buildFactorCoef(self,dfSec,dfFact, rfRate, cols):
        ...
        for idx, col in enumerate(cols):
            ...
            factBetas[idx]=betas
            factIntercepts[idx] = intercepts           
            

        return factBetas,factIntercepts, errEst
    ...
    def buildBayesFactorCoef(self,dfSec,dfFact, rfRate, cols):
        ...
        def bayesRegress(X,Y, sampdraws):
            ...
            with pm.Model() as normal_model:
                ...
                # Inference!
                normal_trace = pm.sample(draws=sampdraws, chains = 2, tune = 500, progressbar = False, cores=4)
            ...
            return coef, normal_trace['alpha'].mean(axis=0), err, post_pred['likelihood'].mean(axis=0)
        ...
        for idx, col in enumerate(cols):
            ...
            betas, intercept, err, predRtn = bayesRegress(X,Y, 2000)
